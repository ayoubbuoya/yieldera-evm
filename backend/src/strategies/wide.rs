...
use crate::{
    core::coingecko, state::AppState, strategies::Strategy, types::{AIResponse, RangeSuggestion, StrategyType}, utils::extract_json_from_markdown
};
